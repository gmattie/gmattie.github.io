 ...
 *     HTMLWebpackPlugin:  Copies and/or minifies "index.html" and "contentMap.xml" from the /source folder to the /build folder.
 * 
 * 
 */
module.exports = (env, argv) => {
    ...
    config.plugins.push(
        new HTMLWebpackPlugin({
            inject: false,
            minify: (argv.mode === "production") ? minifyOptions : {},
    ...
    config.plugins.push(
        new HTMLWebpackPlugin({
            inject: false,
            minify: (argv.mode === "production") ? minifyOptions : { keepClosingSlash: true },
            template: path.resolve(SOURCE_DIR, "./data/contentMap.xml"),
            filename: "./data/contentMap.xml"
        })
    );
