...
class Outline {
    ...
    draw(width, height) {
        ...
        const context = this._context;
        context.clearRect(-C.Line.TRANSLATION, -C.Line.TRANSLATION, context.canvas.width, context.canvas.height);
        context.beginPath();
        context.moveTo(0, 0);
        ...
        gradient.addColorStop("0", `rgba(${this._grayChannel}, ${this._grayChannel}, ${this._grayChannel}, 0)`);
        gradient.addColorStop("1", `rgba(${this._grayChannel}, ${this._grayChannel}, ${this._grayChannel}, 255)`);
